...
public class SmartHomeUI extends Ice.Application {
	...
	/**
	 * UI ICE implementation.
	 * Receive energy usage statistics.
	 */
	@SuppressWarnings("serial")
	public class UII extends _UIDisp {
		
		/**
		 * Receive RMI message from ICE about energy usage.
		 * Print Energy Warning Message. 
		 * @param value Energy Usage Value
		 */
		@Override
	 ...
	 * Handle user input from standard in.
	 ...
	 * @param hmPrx HomeManagerPrx Ice Object for RPC/RMI communications.
	 * @throws IOException
	 */
	...
	/**
	 * Make RPC/RMI call to HomeManger to view Temperature Log
	...
	/**
	 * Make RPC/RMI call to HomeManger to view Media Tracks of a Disc.
	 * 	Print results to console.
	 * @param hmPrx HomeManagerPrx Ice Object for RPC/RMI communications. 
	 * @param discTitle String of the Disc Title
	 * @throws IOException
	 */
	private static void viewDiscTracks(HMPrx hmPrx, String discTitle) throws IOException {
		BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
	...
	public int run(String[] args) {
		...
		Ice.ObjectPrx obj = communicator().stringToProxy("hm:tcp -h 127.0.0.1 -p 12001");
