...
public class HomeManager extends Ice.Application {
    ...
    public int run(String[] args) {
        ...
        Ice.ObjectPrx tempAlertSubscriber = getIceStormSubscriber(
                tempAlertTopic, "SmartHouse.TempSensorWarning",
                new TempSensorWarningI());
        ...
        Ice.ObjectAdapter uiListener = communicator()
                .createObjectAdapterWithEndpoints("HM",
                        "tcp -h 127.0.0.1 -p 12001");
